...
public class AnnouncementsInWeekStudent {
    ...
    public AnnouncementsInWeekStudent(String title, String desciption, Date dateFinish,
                               Date hourFinish) {
        super();
        this.title = title;
        this.desciption = desciption;
    ...
    public AnnouncementsInWeekStudent() {
        super();
    }
